...
| src/components/PaymentModal.tsx | React | "Marcar Pagado" modal (single + bulk); NetSuite-prefilled fields (Cliente, Estatus OC, N° de Factura, Referencia de Operación) plus derived-only Propuesta |
